...
$.extend( FixedHeader.prototype, {
    ...
    window.onresize = function(event) {
      ...
      that.update();
		...
		dt.on( 'destroy.dtfc', function () {
			dt.off( '.dtfc' );
			$(this.c.elScroll).off( that.s.namespace );
		} );
	...
	{
		var windowTop = $(this.c.elScroll).scrollTop();
		var windowLeft = $(this.c.elScroll).scrollLeft();
		var position = this.s.position;
...
FixedHeader.defaults = {
	...
	headerOffset: 0,
	footerOffset: 0,
  elScroll: '#content .content' // window '#content .content'
};
